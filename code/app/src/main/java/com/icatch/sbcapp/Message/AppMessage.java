package com.icatch.sbcapp.Message;
...
public class AppMessage {
    ...
    public static final int MESSAGE_STREAM_CLOSED = LOCAL_VIDEO_PBACTIVITY + 0X06;

    //For other 0x1000~0x1FFF
    public final static int FUNCTION_MESSAGE = 0x1000;

    public static final int MESSAGE_DISCONNECTED = FUNCTION_MESSAGE + 0X01;
    public static final int MESSAGE_CONNECTED = FUNCTION_MESSAGE + 0X02;
