...
/**
 * Created by zhang yanhu C001012 on 2016/12/30 13:42.
 */


/**
 * Created by b.jiang on 2016/12/30.
 */
...
public class QRCode {
    ...
    /**
     * 生成二维码，默认大小为WIDTH*WIDTH
     *
     * @param text 需要生成二维码的文字、网址等
     * @return bitmap
     */
    public static Bitmap createQRCode(String text) {
        return createQRCode(text, WIDTH);
    }
    ...
    /**
     * 生成带logo的二维码，默认二维码的大小为WIDTH，logo为二维码的1/5
     *
     * @param text 需要生成二维码的文字、网址等
    ...
    public static Bitmap createQRCodeWithLogo(String text, Bitmap mBitmap) {
        return createQRCodeWithLogo(text,WIDTH,mBitmap);
    }
